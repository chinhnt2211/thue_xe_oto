...
function UpdateContractImages({ id, setIsComplete }) {
    ...
    const path = import.meta.env.VITE_API_VERSION + '/contracts/' + id.toString() + '/images';
            ...
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                <div className="rounded-t bg-white mb-0 px-6 py-6">
                    <div className="text-center flex justify-between">
                        <h6 className="text-blueGray-700 text-xl font-bold">Thông tin hợp đồng</h6>
                        <div>
                            <button
                ...
                <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <h6 className="text-blueGray-400 text-sm mt-3 mb-6 font-bold uppercase">Ảnh hợp đồng</h6>
...
export default UpdateContractImages;
