...
export default function CardStations({ color }) {
    ...
    return (
        <div>
            <Link to={config.routes.admin.stations.store}>
                <button
                    className={
                            ...
                            {data.map((each) => (
                                <tr key={each.id}>
                                    <th className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left flex items-center">
                                        ...
                                        >
                                            <Link to={config.routes.admin.stations.home + '/' + each.id.toString()}>
                                                {each.id}
                                            </Link>
                                        </span>
                                    </th>
                                    ...
                                    <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right">
                                        <TableDropdown id={each.id} path={config.routes.admin.stations.home} />
                                    </td>
                                </tr>
                            ))}
                        </tbody>
...
CardStations.defaultProps = {
    color: 'light',
};

CardStations.propTypes = {
